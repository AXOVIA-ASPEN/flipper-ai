...
export default function ListingDetailPage() {
  return (
    <Suspense
      fallback={
        <div style={{ minHeight: '100vh', padding: '32px 24px', color: '#94a3b8' }}>
          Loading listing...
        </div>
      }
    >
      ...
      <div style={{ minHeight: '100vh', padding: '32px 24px' }}>
        <div style={{ maxWidth: 1024, margin: '0 auto' }}>
          ...
          <div className="fp-glass" style={{ overflow: 'hidden' }}>
            ...
            {primaryImageUrl && (
              <div
                style={{ height: 288, overflow: 'hidden', background: 'rgba(255,255,255,0.04)' }}
              >
                <img
                  src={primaryImageUrl}
                  alt={listing.title}
            ...
            <div style={{ padding: 24 }}>
              ...
              {staleAnalysis && (
                ...
                >
                  ...
                  <span style={{ fontSize: 13, color: '#fcd34d' }}>
                    Analysis may be outdated — the asking price has changed since the last AI
                    analysis. A fresh analysis is being generated.
                  </span>
                </div>
              )}
                  ...
                  onListPlatform={async (platform, finalPrice) => {
                    ...
                    try {
                      ...
                      if (!res.ok) {
                        ...
                        const detail =
                          typeof data.error === 'object' ? data.error?.detail : data.error;
              ...
              {listing.description && (
                <div style={{ marginBottom: 24 }}>
                  ...
                  <p style={{ color: '#e2e8f0', whiteSpace: 'pre-line', fontSize: 14 }}>
                    {listing.description}
                  </p>
                </div>
              )}
              ...
              {listing.opportunity && (
                ...
                >
                  <div>
                    <div
                      style={{ fontSize: 12, color: '#c4b5fd', fontWeight: 600, marginBottom: 4 }}
                    >
                      Opportunity Status
                    </div>
                    <div style={{ color: '#e2e8f0', fontWeight: 500 }}>
                      {listing.opportunity.status}
                    </div>
                  </div>
                  <Link href="/opportunities" className="fp-btn-primary" style={{ fontSize: 14 }}>
                    View Opportunities →
                  </Link>
                </div>
              )}
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          style={{
                            fontSize: 14,
                            color: '#f87171',
                            opacity: cancellingMeeting ? 0.5 : 1,
                          }}
                        >
          ...
          onSaved={(meeting) => {
            setListing((prev) =>
              prev
                ? {
                    ...prev,
                    opportunity: prev.opportunity ? { ...prev.opportunity, ...meeting } : null,
                  }
                : prev
            );
          }}
