...
// GitHub sign-in is hidden by default. The provider must be enabled in the
// Firebase Console before the button can work; until then, showing it would
// produce an auth/operation-not-allowed error on click. Flip on by setting
// NEXT_PUBLIC_ENABLE_GITHUB_AUTH=true once GitHub is configured in Firebase.
const GITHUB_AUTH_ENABLED = process.env.NEXT_PUBLIC_ENABLE_GITHUB_AUTH === 'true';
