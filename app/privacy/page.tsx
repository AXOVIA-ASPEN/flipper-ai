      ...
      <div style={{ maxWidth: 1024, margin: '0 auto', padding: '48px 16px' }}>
        ...
        >
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              Welcome to Flipper.ai (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We
              are committed to protecting your personal information and your right to privacy. This
              Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you use our marketplace flipping application and related services (collectively,
          ...
          <section>
            ...
            <ul style={LIST_STYLE}>
              ...
              <li>
                <strong>Profile Data:</strong> Optional profile picture, bio, location preferences
              </li>
              <li>
              ...
              <li>
                <strong>Communication Data:</strong> Messages sent through our in-app messaging
                system
              </li>
              <li>
                <strong>User Content:</strong> Item listings, notes, photos, and descriptions you
                create
              </li>
            </ul>
            ...
            <ul style={LIST_STYLE}>
              ...
              <li>
                <strong>Cookies and Tracking:</strong> Session cookies, preference cookies,
                analytics cookies
              </li>
            </ul>
            ...
            <p style={BODY_STYLE}>
              We collect publicly available marketplace data (listings, prices, seller information)
              from third-party platforms (eBay, Craigslist, Facebook Marketplace, OfferUp, Mercari)
              to provide you with market insights. We do not collect private messages or non-public
          ...
          <section>
            ...
            <ul style={LIST_STYLE}>
              <li>
                <strong>Payment Processing:</strong> Stripe (PCI-DSS compliant)
              </li>
              <li>
                <strong>Cloud Hosting:</strong> Google Cloud (Firebase Hosting, Cloud Run),
                PostgreSQL
              </li>
              <li>
                <strong>AI Analysis:</strong> Google Gemini API (for marketplace insights)
              </li>
              <li>
                <strong>Error Monitoring:</strong> Sentry (for bug tracking and performance)
              </li>
              <li>
                <strong>Analytics:</strong> Firebase Analytics (aggregated, non-identifiable data)
              </li>
              <li>
                <strong>Google Calendar:</strong> When you connect Google Calendar, Flipper AI
                writes, updates, and deletes calendar events on your behalf using the{' '}
                <code>calendar.events</code> scope. No calendar data is read or stored by Flipper AI
                — we only create/modify events for your scheduled buy/sell meetups. You can revoke
                access at any time via Settings → Integrations → Disconnect, or directly through
                your{' '}
                <a
                ...
                . Revoking access removes your tokens from our database immediately.
              </li>
            </ul>
          ...
          <section>
            ...
            <ul style={LIST_STYLE}>
              ...
              <li>
                <strong>Deletion:</strong> Request deletion of your account and data (right to be
                forgotten)
              </li>
              <li>
              ...
              <li>
                <strong>Opt-Out:</strong> Unsubscribe from marketing emails (link in footer of
                emails)
              </li>
              <li>
                <strong>Do Not Sell:</strong> We do not sell your personal information to third
                parties
              </li>
            </ul>
            <p style={{ ...BODY_STYLE, marginTop: 16 }}>
              To exercise these rights, email us at <strong>privacy@flipper-ai.com</strong> or use
          ...
          <section>
            ...
            <ul style={LIST_STYLE}>
              ...
              <li>
                <strong>Analytics Cookies:</strong> Understand how you use the Service (Firebase
                Analytics)
              </li>
              <li>
                <strong>Marketing Cookies:</strong> Deliver relevant ads (with your consent)
              </li>
            </ul>
            <p style={{ ...BODY_STYLE, marginTop: 16 }}>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              Flipper.ai is not intended for users under 18 years of age. We do not knowingly
              collect personal information from children. If you believe we have collected data from
              a child, please contact us immediately at <strong>privacy@flipper-ai.com</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              country. By using the Service, you consent to this transfer. We ensure appropriate
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              page with an updated &ldquo;Last Updated&rdquo; date. Significant changes will be
              communicated via email or in-app notification. Your continued use of the Service after
          ...
          <section data-testid="legal-content-card">
            ...
            <div className="fp-glass-sm" style={{ padding: 16 }}>
              <p style={BODY_STYLE}>
                <strong>Email:</strong> privacy@flipper-ai.com
              </p>
              <p style={BODY_STYLE}>
                <strong>Support:</strong> support@flipper-ai.com
              </p>
              <p style={BODY_STYLE}>
                <strong>Company:</strong> Axovia AI (Flipper.ai)
              </p>
              <p style={BODY_STYLE}>
                <strong>Website:</strong>{' '}
                <Link href="/" style={LINK_STYLE} className="hover:underline">
                  https://flipper-ai.com
                </Link>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>California residents have the right to:</p>
            <ul style={{ ...LIST_STYLE, marginTop: 12 }}>
        ...
        <div style={{ marginTop: 32, textAlign: 'center', fontSize: 13, color: TEXT_SECONDARY }}>
          <Link href="/terms" style={LINK_STYLE} className="hover:underline">
            Terms of Service
          </Link>
          {' | '}
          <Link href="/" style={LINK_STYLE} className="hover:underline">
