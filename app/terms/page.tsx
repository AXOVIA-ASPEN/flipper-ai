    ...
    <div style={{ minHeight: '100vh', color: TEXT_PRIMARY }}>
      <div style={{ maxWidth: 1024, margin: '0 auto', padding: '48px 16px' }}>
        ...
        >
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              between you and Axovia AI (&ldquo;Flipper.ai,&rdquo; &ldquo;we,&rdquo;
              &ldquo;us,&rdquo; or &ldquo;our&rdquo;) regarding your use of the Flipper.ai
              marketplace flipping application and related services (collectively, the
              &ldquo;Service&rdquo;).
            </p>
          ...
          <section>
            ...
            <ul style={{ ...LIST_STYLE, marginTop: 12 }}>
              ...
              <li>
                Scrape, harvest, or collect data from third-party marketplaces beyond our permitted
                scope
              </li>
              ...
              <li>
                Use automated bots or scripts to abuse the Service (except our provided features)
              </li>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              You must comply with each platform&rsquo;s terms of service when conducting
              transactions.
            </p>
          ...
          <section>
            ...
            <ul style={LIST_STYLE}>
              <li>
                <strong>Free Plan:</strong> Limited features (5 scans/month, basic tracking)
              </li>
              <li>
                <strong>Pro Plan:</strong> $15/month (unlimited scans, AI analysis, full features)
              </li>
              <li>
                <strong>Team Plan:</strong> $40/month (multi-user access, advanced analytics)
              </li>
            </ul>
            ...
            <p style={BODY_STYLE}>
              ...
              charge your payment method on a recurring basis. All fees are non-refundable unless
              required by law.
            </p>

            <h3 style={H3_STYLE}>6.3 Cancellation</h3>
            <p style={BODY_STYLE}>
              You may cancel your subscription at any time through account settings. Cancellation
              takes effect at the end of your current billing period. No partial refunds are
              provided.
            </p>

            <h3 style={H3_STYLE}>6.4 Price Changes</h3>
            <p style={BODY_STYLE}>
              We reserve the right to change pricing at any time. You will receive 30 days&rsquo;
              notice of any price increases. Continued use after the notice period constitutes
              acceptance.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              software, design, text, graphics, logos, AI models) are owned by Axovia AI and
            ...
            <p style={BODY_STYLE}>
              You retain ownership of any content you create or upload (listings, notes, photos). By
              using the Service, you grant us a worldwide, non-exclusive, royalty-free license to
          ...
          <section>
            ...
            <div
              className="fp-alert-danger"
              style={{ padding: 16, marginTop: 16, marginBottom: 16 }}
            >
              <p style={{ ...BODY_STYLE, fontWeight: 600 }}>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, AXOVIA AI SHALL NOT BE LIABLE FOR ANY
                INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF
                PROFITS, REVENUE, DATA, OR USE.
              </p>
            </div>
            <p style={BODY_STYLE}>
          ...
          <section>
            ...
            <p style={BODY_STYLE}>
              ...
              <strong>support@flipper-ai.com</strong>
            ...
            <p style={BODY_STYLE}>
              ...
              binding arbitration conducted by the American Arbitration Association (AAA) under its
              Commercial Arbitration Rules. The arbitration will be conducted in English, and the
            ...
            <p style={BODY_STYLE}>
              ...
              infringement or unauthorized access.
            </p>
          </section>
          ...
          <section data-testid="legal-content-card">
            ...
            <div className="fp-glass-sm" style={{ padding: 16 }}>
              <p style={BODY_STYLE}>
                <strong>Email:</strong> support@flipper-ai.com
              </p>
              <p style={BODY_STYLE}>
                <strong>Legal:</strong> legal@flipper-ai.com
              </p>
              <p style={BODY_STYLE}>
        ...
        <div style={{ marginTop: 32, textAlign: 'center', fontSize: 13, color: TEXT_SECONDARY }}>
          <Link href="/privacy" style={LINK_STYLE} className="hover:underline">
            Privacy Policy
          </Link>
          {' | '}
          <Link href="/" style={LINK_STYLE} className="hover:underline">
