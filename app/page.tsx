      ...
      <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-bold mb-6" style={{ color: '#e2e8f0' }}>
              Find Hidden Profits in <span className="fp-grad-purple">Every Marketplace</span>
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto" style={{ color: '#94a3b8' }}>
              AI-powered marketplace scanner that finds underpriced items on Craigslist, Facebook,
              eBay, OfferUp, and Mercari. Turn $50 into $500 with smart flipping.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="fp-glow-card fp-glass p-6">
              ...
              <h4 className="text-xl font-semibold mb-2" style={{ color: '#e2e8f0' }}>
                Multi-Platform Scanning
              </h4>
              <p style={{ color: '#94a3b8' }}>
                Search Craigslist, Facebook Marketplace, eBay, OfferUp, and Mercari simultaneously.
                Never miss a deal.
              </p>
            </div>
            ...
            <div className="fp-glow-card fp-glass p-6">
              ...
              <p style={{ color: '#94a3b8' }}>
                Claude AI analyzes every listing to estimate market value and profit potential in
                seconds.
              </p>
            </div>
            ...
            <div className="fp-glow-card fp-glass p-6">
              ...
              <p style={{ color: '#94a3b8' }}>
                See instant profit projections including fees, shipping, and resale difficulty
                ratings.
              </p>
            </div>
            ...
            <div className="fp-glow-card fp-glass p-6">
              ...
              <p style={{ color: '#94a3b8' }}>
                Get instant notifications when high-value opportunities appear. Beat the
                competition.
              </p>
            </div>
            ...
            <div className="fp-glow-card fp-glass p-6">
              ...
              <p style={{ color: '#94a3b8' }}>
                Track trends, sold listings, and pricing history to make data-driven flipping
                decisions.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
            ...
            <div className="fp-glass p-8 rounded-xl">
              ...
              <button onClick={handleGetStarted} className="fp-btn-ghost w-full">
                Start Free
              </button>
            </div>
            ...
            <div className="fp-hot-card fp-glass p-10 rounded-xl">
              ...
              <button onClick={handleGetStarted} className="fp-btn-primary w-full">
                Start Pro Trial
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="fp-glass p-12 rounded-2xl text-center">
            ...
            <button onClick={handleGetStarted} className="fp-btn-hot text-lg px-8 py-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-6 text-sm" style={{ color: '#94a3b8' }}>
              <Link href="/privacy" className="hover:underline" style={{ color: '#94a3b8' }}>
                Privacy
              </Link>
              <Link href="/terms" className="hover:underline" style={{ color: '#94a3b8' }}>
                Terms
              </Link>
              <Link href="/contact" className="hover:underline" style={{ color: '#94a3b8' }}>
                Contact
              </Link>
            </div>
          </div>
