...
const SEED_LISTINGS: SeedListing[] = [
  // Electronics (15)
  {
    ...
    description: 'Barely used iPhone 14 Pro Max. Original box and charger.',
    askingPrice: 450,
    estimatedValue: 750,
  ...
  {
    title: 'MacBook Pro M2 14" 16GB - Mint',
    description: 'Perfect condition MacBook Pro. AppleCare+ until 2025.',
    askingPrice: 1200,
    estimatedValue: 1800,
    category: 'Electronics',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Unlocked, titanium black, includes case.',
    askingPrice: 600,
    estimatedValue: 950,
    category: 'Electronics',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Selling because I upgraded. Screen perfect.',
    askingPrice: 250,
    estimatedValue: 420,
    category: 'Electronics',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Best noise canceling. Received as gift, already have a pair.',
    askingPrice: 150,
    estimatedValue: 300,
    category: 'Electronics',
    condition: 'New',
  ...
  },
  {
    ...
    description: 'Complete drone kit with extra batteries and ND filters.',
    askingPrice: 400,
    estimatedValue: 700,
    category: 'Electronics',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Low shutter count, just upgraded to R5.',
    askingPrice: 900,
    estimatedValue: 1500,
    category: 'Electronics',
    condition: 'Excellent',
  ...
  },
  {
    ...
    description: 'Barely worn, includes extra bands.',
    askingPrice: 450,
    estimatedValue: 700,
    category: 'Electronics',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Great portable speaker. Too many speakers already.',
    askingPrice: 60,
    estimatedValue: 120,
    category: 'Electronics',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Work laptop, company provided new one.',
    askingPrice: 700,
    estimatedValue: 1200,
    category: 'Electronics',
    condition: 'Good',
    ...
    demandLevel: 'medium',
    sellabilityScore: 80,
    expectedDaysToSell: 8,
  },
  {
    title: 'AirPods Pro 2nd Gen USB-C',
    description: 'Sealed in box. Won at company raffle.',
    askingPrice: 120,
    estimatedValue: 220,
    category: 'Electronics',
    condition: 'New',
  ...
  },
  {
    ...
    description: 'Moving sale, need gone ASAP.',
    askingPrice: 200,
    estimatedValue: 380,
    category: 'Electronics',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Downsizing apartment, too big for new place.',
    askingPrice: 200,
    estimatedValue: 380,
    category: 'Electronics',
    condition: 'Excellent',
  ...
  },
  {
    ...
    description: 'Used once on vacation. Includes mounts and case.',
    askingPrice: 200,
    estimatedValue: 350,
    category: 'Electronics',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: "VR isn't for me. Includes elite strap.",
    askingPrice: 250,
    estimatedValue: 450,
    category: 'Electronics',
    condition: 'Like New',
  ...
  // Furniture (10)
  {
    ...
    description: 'Office closing sale. Fully loaded, great condition.',
    askingPrice: 350,
    estimatedValue: 800,
    category: 'Furniture',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Ergonomic office chair, black fabric.',
    askingPrice: 200,
    estimatedValue: 500,
    category: 'Furniture',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Solid walnut, beautiful piece. Moving overseas.',
    askingPrice: 300,
    estimatedValue: 600,
    category: 'Furniture',
    condition: 'Excellent',
    brand: 'West Elm',
    model: 'Mid-Century Desk',
    demandLevel: 'medium',
    sellabilityScore: 72,
  ...
  },
  {
    ...
    description: 'Perfect condition, disassembled for easy transport.',
    askingPrice: 40,
    estimatedValue: 90,
    category: 'Furniture',
    condition: 'Good',
  ...
  {
    title: 'Standing Desk - FlexiSpot E7 Pro',
    description: 'Electric standing desk, 60x30, bamboo top.',
    askingPrice: 250,
    estimatedValue: 500,
    category: 'Furniture',
    condition: 'Good',
  ...
  {
    title: 'CB2 Leather Sofa - 3 Seat',
    description: 'Genuine leather, cognac color. Minor wear.',
    askingPrice: 600,
    estimatedValue: 1400,
    category: 'Furniture',
    condition: 'Good',
  ...
  {
    title: 'Pottery Barn Dining Table + 6 Chairs',
    description: 'Solid wood, seats 6-8. Excellent condition.',
    askingPrice: 500,
    estimatedValue: 1200,
    category: 'Furniture',
    condition: 'Excellent',
  ...
  {
    title: 'Article Timber Sofa - Charme Tan',
    description: 'Premium leather, 1 year old. Moving sale.',
    askingPrice: 800,
    estimatedValue: 1600,
    category: 'Furniture',
    condition: 'Like New',
  ...
  {
    title: 'Restoration Hardware Cloud Couch Sections',
    description: '2 corner + 1 armless sections. Gray linen.',
    askingPrice: 2000,
    estimatedValue: 5000,
    category: 'Furniture',
    condition: 'Good',
  ...
  {
    title: 'UPLIFT V2 Standing Desk Frame',
    description: 'Frame only, black. Works perfectly.',
    askingPrice: 150,
    estimatedValue: 350,
    category: 'Furniture',
    condition: 'Good',
  ...
  // Gaming (8)
  {
    ...
    description: 'Perfect condition. Games: Spider-Man 2, FF7, GOW.',
    askingPrice: 350,
    estimatedValue: 550,
    category: 'Gaming',
    condition: 'Excellent',
  ...
  },
  {
    ...
    description: 'Barely used, prefer PC gaming.',
    askingPrice: 280,
    estimatedValue: 430,
    category: 'Gaming',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Bought last month, not using enough. Includes case.',
    askingPrice: 400,
    estimatedValue: 600,
    category: 'Gaming',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Analog switches, magnetic. Like new.',
    askingPrice: 100,
    estimatedValue: 200,
    category: 'Gaming',
    condition: 'Like New',
  ...
  {
    title: 'Secretlab Titan Evo 2022 Chair',
    description: 'Leatherette, dark knight edition. Great condition.',
    askingPrice: 250,
    estimatedValue: 450,
    category: 'Gaming',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Perfect for streaming setup. All buttons work.',
    askingPrice: 60,
    estimatedValue: 120,
    category: 'Gaming',
    condition: 'Good',
  ...
  },
  {
    ...
    description: '165Hz IPS, 1440p. Upgrading to OLED.',
    askingPrice: 200,
    estimatedValue: 350,
    category: 'Gaming',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Multi-system wireless headset. Excellent sound.',
    askingPrice: 150,
    estimatedValue: 280,
    category: 'Gaming',
    condition: 'Good',
  ...
  // Sports & Outdoors (8)
  {
    ...
    description: "Moving, can't take it. Includes mat, weights, shoes.",
    askingPrice: 800,
    estimatedValue: 1500,
    category: 'Sports',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Carbon frame, Shimano 105. 2000 miles.',
    askingPrice: 1200,
    estimatedValue: 2200,
    category: 'Sports',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Used twice camping. Basically new.',
    askingPrice: 150,
    estimatedValue: 300,
    category: 'Sports',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Titanium, sapphire lens. Switching to Apple Watch.',
    askingPrice: 350,
    estimatedValue: 600,
    category: 'Sports',
    condition: 'Excellent',
  ...
  },
  {
    ...
    description: 'Used 3x. Clean, no damage. Includes footprint.',
    askingPrice: 100,
    estimatedValue: 220,
    category: 'Sports',
    condition: 'Good',
  ...
  {
    title: 'Bowflex SelectTech 552 Dumbbells (Pair)',
    description: 'Adjustable 5-52.5 lbs. Garage gym clearing.',
    askingPrice: 150,
    estimatedValue: 320,
    category: 'Sports',
    condition: 'Good',
  ...
  {
    title: 'Hydrow Rower - Like New',
    description: 'Under warranty. Moving to smaller apartment.',
    askingPrice: 800,
    estimatedValue: 1600,
    category: 'Sports',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Medium. Used for one thru-hike. Great condition.',
    askingPrice: 100,
    estimatedValue: 230,
    category: 'Sports',
    condition: 'Good',
  ...
  // Collectibles & Misc (9)
  {
    ...
    description: 'Sealed! Won at charity raffle.',
    askingPrice: 600,
    estimatedValue: 1000,
  ...
  },
  {
    ...
    description: 'Best cordless vacuum. Upgrading to robot vac.',
    askingPrice: 300,
    estimatedValue: 550,
    category: 'Home',
    condition: 'Good',
  ...
  },
  {
    ...
    description: '5-qt, barely used. Moving gift.',
    askingPrice: 150,
    estimatedValue: 330,
    category: 'Home',
    condition: 'Like New',
  ...
  },
  {
    ...
    description: 'Original pickups, some wear. Plays beautifully.',
    askingPrice: 3000,
    estimatedValue: 8000,
  ...
  },
  {
    ...
    description: 'Makes cafe-quality coffee. All accessories included.',
    askingPrice: 300,
    estimatedValue: 550,
    category: 'Home',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Graded PSA 7. Classic card.',
    askingPrice: 200,
    estimatedValue: 400,
    category: 'Collectibles',
    condition: 'Good',
    brand: 'Pokemon',
    model: 'Base Set Charizard',
    variant: 'PSA 7',
    demandLevel: 'very_high',
    sellabilityScore: 93,
    expectedDaysToSell: 2,
  },
  {
    ...
    description: "6 months old. Works perfectly. Just don't need it.",
    askingPrice: 250,
    estimatedValue: 450,
    category: 'Home',
    condition: 'Good',
  ...
  },
  {
    ...
    description: '3-burner, side burner. One season of use.',
    askingPrice: 400,
    estimatedValue: 750,
    category: 'Home',
    condition: 'Good',
  ...
  },
  {
    ...
    description: 'Commercial grade blender. Smoothie king at home.',
    askingPrice: 200,
    estimatedValue: 400,
    category: 'Home',
    condition: 'Good',
    brand: 'Vitamix',
    model: 'Professional 750',
    demandLevel: 'high',
    sellabilityScore: 83,
    expectedDaysToSell: 5,
  },
...
async function main() {
  ...
  for (let i = 0; i < SEED_LISTINGS.length; i++) {
    ...
    const discountPercent = Math.round(
      ((item.estimatedValue - item.askingPrice) / item.estimatedValue) * 100
    );
    ...
    if (['PURCHASED', 'LISTED', 'SOLD'].includes(status)) {
      ...
      const resaleDate = isSold
        ? new Date(purchaseDate.getTime() + (item.expectedDaysToSell || 7) * 86400000)
        : undefined;
      ...
      await prisma.opportunity.upsert({
        ...
        create: {
          ...
          actualProfit: isSold
            ? Math.round(item.estimatedValue * 0.8 - item.askingPrice)
            : undefined,
          status:
            status === 'PURCHASED' ? 'PURCHASED' : status === 'LISTED' ? 'LISTED_FOR_SALE' : 'SOLD',
        },
      });
    }
  ...
  const configs = await Promise.all([
    ...
    prisma.searchConfig.create({
      data: {
        userId: demoUser.id,
        name: 'DFW Furniture Deals',
        platform: 'FACEBOOK_MARKETPLACE',
        location: 'Dallas, TX',
        category: 'Furniture',
        keywords: 'herman miller,steelcase,west elm',
        minPrice: 100,
        maxPrice: 2000,
        enabled: true,
      },
    ...
    prisma.searchConfig.create({
      data: {
        userId: powerUser.id,
        name: 'Gaming Deals Nationwide',
        platform: 'EBAY',
        category: 'Gaming',
        keywords: 'ps5,xbox,steam deck,nintendo',
        minPrice: 100,
        maxPrice: 800,
        enabled: true,
      },
    ...
    prisma.searchConfig.create({
      data: {
        userId: powerUser.id,
        name: 'Collectibles Scanner',
        platform: 'MERCARI',
        category: 'Collectibles',
        keywords: 'lego,pokemon,vintage',
        minPrice: 50,
        maxPrice: 5000,
        enabled: true,
      },
