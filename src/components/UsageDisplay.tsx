...
function UsageBar({ used, limit, label }: { used: number; limit: number; label?: string }) {
  ...
  return (
    <div data-testid="usage-bar">
      ...
      {isApproaching && (
        <div
          className="fp-alert-info mt-2 p-2 text-xs"
          style={{ color: '#93c5fd' }}
      ...
      {isOverLimit && (
        <div
          className="fp-alert-warn mt-2 p-2 text-xs"
          style={{ color: '#fcd34d' }}
          data-testid="usage-warn-banner"
        >
    ...
    <div className="fp-glass-sm p-4">
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs mt-1" style={{ color: '#94a3b8' }}>
          This month: {usage.scans.usedThisMonth} scan{usage.scans.usedThisMonth === 1 ? '' : 's'}{' '}
          recorded
        </p>
