...
describe('Theme Configuration', () => {
  ...
  describe('theme structure validation', () => {
    ...
    test.each(Object.entries(themes))('%s theme should have all required color properties', (_, theme: Theme) => {
    ...
    test.each(Object.entries(themes))('%s theme accent colors should have from/to/shadow', (_, theme: Theme) => {
    ...
    test.each(Object.entries(themes))('%s theme textGradient should have from/via/to', (_, theme: Theme) => {
  ...
  describe('color format validation', () => {
    ...
    test.each(Object.entries(themes))('%s theme primary colors should be valid Tailwind classes', (_, theme: Theme) => {
    ...
    test.each(Object.entries(themes))('%s theme secondary colors should be valid Tailwind classes', (_, theme: Theme) => {
    ...
    test.each(Object.entries(themes))('%s theme orb colors should be valid Tailwind classes', (_, theme: Theme) => {
      theme.colors.orbColors.forEach(color => {
        expect(color).toMatch(tailwindColorRegex);
      });
    });

    test.each(Object.entries(themes))('%s theme text colors should be valid Tailwind classes', (_, theme: Theme) => {
    ...
    test('all themes should use -500 or -600 scale for primary colors', () => {
      Object.values(themes).forEach(theme => {
        const hasPrimaryScale = 
          theme.colors.primaryFrom.includes('-500') || 
          theme.colors.primaryFrom.includes('-600');
