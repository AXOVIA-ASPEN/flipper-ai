...
function generateBacktestDataset(): BacktestItem[] {
  ...
  const collectorPremiumItems = [
    {
      ...
      asking: 350,
      prices: [380, 400, 410, 390, 395, 405, 385, 1200, 1500],
      isGood: true,
    },
    {
      name: 'Nintendo Switch OLED',
      asking: 220,
      prices: [280, 290, 300, 275, 285, 295, 2000],
      isGood: true,
    },
    {
      name: 'PS5 Digital Edition',
      asking: 280,
      prices: [350, 360, 340, 355, 345, 370, 1800, 2200],
      isGood: true,
    },
    {
      name: 'MacBook Air M1',
      asking: 500,
      prices: [650, 680, 670, 660, 640, 690, 2500],
      isGood: true,
    },
    {
      name: 'AirPods Pro 2',
      asking: 120,
      prices: [160, 170, 155, 165, 175, 150, 500, 600],
      isGood: true,
    },
    {
      name: 'Dyson V15 Detect',
      asking: 300,
      prices: [420, 440, 430, 410, 450, 1500],
      isGood: true,
    },
    {
      name: 'KitchenAid Stand Mixer',
      asking: 150,
      prices: [250, 240, 260, 245, 255, 900, 1100],
      isGood: true,
    },
    {
      name: 'Herman Miller Aeron',
      asking: 400,
      prices: [700, 720, 680, 710, 690, 730, 2800],
      isGood: true,
    },
    { name: 'Pioneer DDJ-400', asking: 150, prices: [200, 210, 195, 205, 215, 800], isGood: true },
    {
      ...
      asking: 80,
      prices: [120, 130, 110, 125, 115, 135, 700, 900],
      isGood: true,
    },
    {
      name: 'Xbox Series X',
      asking: 300,
      prices: [380, 390, 370, 385, 375, 395, 1600],
      isGood: true,
    },
    {
      name: 'Samsung Galaxy S23',
      asking: 400,
      prices: [520, 530, 510, 525, 515, 540, 1800, 2000],
      isGood: true,
    },
    {
      name: 'Bose QC45 Headphones',
      asking: 150,
      prices: [200, 210, 195, 205, 190, 215, 700],
      isGood: true,
    },
    {
      name: 'Canon EOS R6',
      asking: 800,
      prices: [1100, 1150, 1080, 1120, 1090, 3500, 4000],
      isGood: true,
    },
    {
      name: 'Leica M6 Silver',
      asking: 2000,
      prices: [3200, 3100, 3300, 3150, 3250, 8000, 12000],
      isGood: true,
    },
  ];
  ...
  const firesaleItems = [
    ...
    { name: 'Vitamix 5200', asking: 200, prices: [320, 330, 310, 325, 315, 20, 30], isGood: true },
    {
      ...
      asking: 400,
      prices: [550, 570, 540, 560, 530, 50],
      isGood: true,
    },
    {
      name: 'Breville Barista Express',
      asking: 250,
      prices: [400, 410, 390, 405, 385, 30, 45],
      isGood: true,
    },
    {
      name: 'iRobot Roomba j7+',
      asking: 200,
      prices: [350, 340, 360, 345, 355, 25, 35],
      isGood: true,
    },
    {
      name: 'Steelcase Leap V2',
      asking: 350,
      prices: [500, 520, 490, 510, 480, 40, 50, 60],
      isGood: true,
    },
    { name: 'Peloton Bike', asking: 500, prices: [800, 820, 780, 810, 790, 100, 75], isGood: true },
    {
      ...
      asking: 300,
      prices: [450, 460, 440, 455, 435, 30, 40],
      isGood: true,
    },
    {
      name: 'LG C2 55" OLED',
      asking: 600,
      prices: [900, 920, 880, 910, 890, 100, 50],
      isGood: true,
    },
    {
      name: 'Garmin Fenix 7',
      asking: 250,
      prices: [380, 390, 370, 385, 375, 40, 20],
      isGood: true,
    },
    { name: 'Theragun Pro', asking: 200, prices: [300, 310, 290, 305, 285, 30, 15], isGood: true },
    {
      name: 'Dewalt 20V Max Kit',
      asking: 200,
      prices: [300, 310, 290, 305, 295, 25, 35],
      isGood: true,
    },
    {
      name: 'Milwaukee M18 Fuel',
      asking: 180,
      prices: [280, 270, 290, 275, 285, 20, 30],
      isGood: true,
    },
    {
      name: 'Makita Cordless Set',
      asking: 220,
      prices: [340, 350, 330, 345, 335, 30, 40],
      isGood: true,
    },
  ];
  ...
  const mixedItems = [
    ...
    { name: 'DJI Mini 3 Pro', asking: 400, prices: [580, 600, 570, 590, 50, 1500], isGood: true },
    {
      ...
      asking: 400,
      prices: [550, 570, 540, 560, 80, 1800],
      isGood: true,
    },
    ...
    { name: 'Sennheiser HD660S', asking: 200, prices: [320, 330, 310, 325, 40, 800], isGood: true },
    {
      name: 'Focal Utopia',
      asking: 1500,
      prices: [2500, 2600, 2400, 2550, 300, 6000],
      isGood: true,
    },
  ];
  ...
  const cleanItems = [
    ...
    { name: 'CalDigit TS4', asking: 200, prices: [300, 310, 290, 305, 295, 315], isGood: true },
    {
      ...
      asking: 200,
      prices: [280, 290, 270, 285, 275, 295],
      isGood: true,
    },
  ];
  ...
  const badDeals = [
    // Real value ~$50, outliers at ~$500-800 inflate unfiltered stats
    {
      ...
      asking: 100,
      prices: [45, 50, 48, 52, 47, 53, 500, 600, 700],
      isGood: false,
    },
    {
      name: 'Old Roku Express',
      asking: 80,
      prices: [35, 40, 38, 42, 37, 41, 400, 500, 600],
      isGood: false,
    },
    {
      name: 'Basic Bluetooth Speaker',
      asking: 100,
      prices: [55, 60, 58, 62, 57, 61, 450, 550],
      isGood: false,
    },
    {
      name: 'Used Fitbit Inspire',
      asking: 100,
      prices: [50, 55, 48, 52, 54, 51, 500, 600, 700],
      isGood: false,
    },
    {
      name: 'Old Chromecast 2nd Gen',
      asking: 60,
      prices: [25, 30, 28, 32, 27, 31, 350, 400],
      isGood: false,
    },
    {
      name: 'Worn Nike Running Shoes',
      asking: 90,
      prices: [40, 45, 42, 48, 43, 46, 400, 500],
      isGood: false,
    },
    {
      name: 'Generic Phone Case',
      asking: 30,
      prices: [12, 15, 14, 16, 13, 15, 200, 250],
      isGood: false,
    },
    {
      name: 'Old iPad Mini 2',
      asking: 120,
      prices: [60, 70, 65, 75, 62, 68, 600, 700, 800],
      isGood: false,
    },
    {
      name: 'Used Beats Solo2',
      asking: 90,
      prices: [45, 50, 48, 52, 46, 51, 400, 500],
      isGood: false,
    },
    {
      name: 'Basic Logitech Mouse',
      asking: 50,
      prices: [20, 25, 22, 28, 24, 23, 300, 350],
      isGood: false,
    },
    {
      name: 'Old Kindle Fire 7',
      asking: 65,
      prices: [30, 35, 32, 38, 33, 34, 350, 400],
      isGood: false,
    },
    {
      name: 'Used Apple Pencil 1st',
      asking: 100,
      prices: [55, 60, 58, 62, 57, 59, 500, 600],
      isGood: false,
    },
    {
      name: 'Generic Webcam 1080p',
      asking: 55,
      prices: [25, 30, 28, 32, 26, 29, 300, 350],
      isGood: false,
    },
    {
      name: 'Old Airport Express',
      asking: 70,
      prices: [30, 35, 33, 37, 32, 34, 350, 450],
      isGood: false,
    },
    {
      name: 'Broken PS4 Controller',
      asking: 55,
      prices: [25, 30, 28, 32, 27, 29, 300, 400],
      isGood: false,
    },
    {
      name: 'Old MacBook Charger',
      asking: 50,
      prices: [20, 25, 22, 28, 24, 23, 250, 300],
      isGood: false,
    },
    {
      name: 'Generic HDMI Cable',
      asking: 22,
      prices: [8, 10, 9, 12, 11, 10, 150, 200],
      isGood: false,
    },
    {
      name: 'Used Apple TV 3rd Gen',
      asking: 70,
      prices: [35, 40, 38, 42, 37, 39, 350, 400],
      isGood: false,
    },
    {
      name: 'Old iPod Nano',
      asking: 90,
      prices: [40, 45, 42, 48, 43, 44, 500, 600],
      isGood: false,
    },
    {
      name: 'Worn Adidas Sneakers',
      asking: 80,
      prices: [35, 40, 38, 42, 37, 39, 400, 500],
      isGood: false,
    },
  ];
  ...
  const additionalGoodDeals = [
    {
      name: 'Roomba i7+',
      asking: 200,
      prices: [350, 360, 340, 355, 345, 370, 1500],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Instant Pot Duo Plus',
      asking: 40,
      prices: [70, 75, 65, 72, 68, 78, 300],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 75,
      prices: [130, 140, 125, 135, 128, 142, 500],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 100,
      prices: [170, 180, 165, 175, 160, 185, 600],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Sonos One SL',
      asking: 80,
      prices: [130, 135, 125, 132, 128, 138, 400],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 60,
      prices: [100, 105, 95, 102, 98, 108, 350],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 70,
      prices: [120, 125, 115, 122, 118, 128, 400],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Cricut Maker 3',
      asking: 200,
      prices: [320, 330, 310, 325, 315, 335, 1000],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Oculus Quest 2',
      asking: 150,
      prices: [220, 230, 210, 225, 215, 235, 800],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 80,
      prices: [130, 135, 125, 132, 128, 500],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Lego UCS Millennium Falcon',
      asking: 400,
      prices: [650, 670, 640, 660, 680, 2500, 3000],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 400,
      prices: [600, 620, 580, 610, 590, 630, 2000],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 500,
      prices: [800, 820, 780, 810, 790, 830, 3000],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      name: 'Vitamix A3500',
      asking: 250,
      prices: [400, 420, 390, 410, 380, 430, 1200],
      isGood: true,
      cat: 'collector-premium' as const,
    },
    {
      ...
      asking: 300,
      prices: [500, 520, 480, 510, 490, 530, 1800],
      isGood: true,
      cat: 'collector-premium' as const,
    },
  ];
  ...
  const bimodalItems = [
    {
      name: 'iPhone 13 (mixed storage)',
      asking: 300,
      prices: [350, 360, 370, 355, 650, 680, 700, 670],
      isGood: true,
    },
    {
      name: 'MacBook Pro (mixed year)',
      asking: 600,
      prices: [750, 780, 760, 770, 1200, 1250, 1300, 1180],
      isGood: true,
    },
    {
      name: 'iPad Air (mixed gen)',
      asking: 250,
      prices: [320, 340, 330, 335, 550, 580, 570, 560],
      isGood: true,
    },
    {
      name: 'PS5 Disc vs Digital',
      asking: 300,
      prices: [350, 360, 340, 355, 480, 500, 490, 470],
      isGood: true,
    },
    {
      name: 'Switch Lite vs OLED',
      asking: 150,
      prices: [170, 180, 175, 165, 290, 300, 310, 280],
      isGood: true,
    },
  ];
...
describe('Story 13.1 Backtest: IQR Outlier Filtering Validation', () => {
  ...
  test('AC #4: IQR filtering reduces false-positive high scores', () => {
    ...
    const filteredFalsePositives = results.filter((r) => r.filteredIsOpportunity && !r.isGoodDeal);

    console.log('\n=== AC #4: False Positive Analysis ===');
    console.log(`Total items: ${results.length}`);
    console.log(`Bad deals in dataset: ${results.filter((r) => !r.isGoodDeal).length}`);
    console.log(
      `Unfiltered false positives (scored 70+ but bad deal): ${unfilteredFalsePositives.length}`
    );
    console.log(
      `Filtered false positives (scored 70+ but bad deal): ${filteredFalsePositives.length}`
    );
    console.log(
      `False positive reduction: ${unfilteredFalsePositives.length - filteredFalsePositives.length}`
    );
  ...
  test('AC #5: No false negatives introduced (good deals still score 70+)', () => {
    ...
    console.log(
      `Good deals scoring 70+ before filtering: ${results.filter((r) => r.isGoodDeal && r.unfilteredIsOpportunity).length}`
    );
    console.log(
      `Good deals scoring 70+ after filtering: ${results.filter((r) => r.isGoodDeal && r.filteredIsOpportunity).length}`
    );
  ...
  test('summary report', () => {
    ...
    for (const cat of categories) {
      ...
      const avgScoreDelta = catItems.reduce((sum, r) => sum + r.scoreDelta, 0) / catItems.length;
      const avgMedianDelta = catItems.reduce((sum, r) => sum + r.medianDelta, 0) / catItems.length;
    ...
    console.log(
      `False positive reduction: ${unfilteredFP - filteredFP} (${unfilteredFP > 0 ? Math.round(((unfilteredFP - filteredFP) / unfilteredFP) * 100) : 0}%)`
    );
