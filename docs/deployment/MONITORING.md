...
# Cron: */5 * * * * /path/to/scripts/health/health-monitor.sh >> /var/log/flipper-health.log 2>&1
...
4. [ ] Add status page URL to `docs/deployment/PRODUCTION_READINESS.md`
5. [ ] (Optional) Add webhook alert to Slack `#flipper-alerts` channel

---

_Generated by ASPEN — Feb 17, 2026_
