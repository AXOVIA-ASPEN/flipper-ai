...
| -------------- | ------- | --------- | -------------------- |
| **Statements** | 34.4%   | 80%       | ❌ FAILING (-45.6%)  |
| **Branches**   | 24.91%  | 70%       | ❌ FAILING (-45.09%) |
| **Lines**      | 34.19%  | 80%       | ❌ FAILING (-45.81%) |
| **Functions**  | 31.93%  | 80%       | ❌ FAILING (-48.07%) |
...
## ⚠️ Files with Partial Coverage (<90%)
...
4. **Improve Partial Coverage** (Est: 3 hours)
   - [ ] Expand `claude-analyzer.test.ts` (38.2% → 90%)
   - [ ] Expand `image-service.test.ts` (68% → 90%)
   - [ ] Expand `price-history-service.test.ts` (78% → 90%)
...
_Generated by ASPEN 🌲 - Flipper AI Task Worker_
