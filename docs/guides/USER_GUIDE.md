...
**Welcome to Flipper AI!** Your intelligent assistant for finding profitable flipping opportunities across multiple marketplaces.
...
**Pro Tip:** Bookmark `/dashboard` for quick access!

---

## 🔍 Finding Opportunities

### 3. Configure Marketplace Scans

Navigate to **Scraper** from the top menu.
...
2. **Enter Search Terms**
   - Keywords: `iPhone, Nintendo, Dyson, vintage camera`
   - Category: Electronics, Home Goods, Collectibles, etc.
   - Location: Your city/zip code

3. **Set Filters**
   - Max Price: $500
   - Min Profit Potential: $50
...
- Run scans daily for fresh inventory
...
- 💵 **Profit Potential:** Value minus price
- 🎯 **Flippability Score:** 0-100 AI rating
...
- Category (Electronics, Collectibles, etc.)

---

### 5. AI Analysis Deep Dive
...
- 💲 **Suggested Offer:** Negotiation starting point
- 📊 **Market Data:** Recent sold prices
- 🔍 **Comparable Sales:** Similar items

**Pro Tip:** Always check the "Risks" section before buying!
...
- Inspect item before finalizing purchase

---

### 7. Track Conversations
...
- Pick up quickly to close the deal
...
Once you buy an item, update its status:

1. Go to **Opportunities** page
2. Find the listing
3. Click **Edit** (pencil icon)
4. Change status to **PURCHASED**
5. Enter **Purchase Price:** (what you paid)
6. Enter **Purchase Date**
7. Add **Notes:** (condition, negotiation details)
...
- 📝 **Listed:** Posted for resale
- 💵 **Sold:** Transaction complete
- ❌ **Passed:** Decided not to pursue

**Drag & Drop:** Move cards between columns as status changes.

**Pro Tip:** Regularly review "Contacted" stage to follow up on pending deals.

---

## 💰 Reselling for Profit

### 10. Create Resale Listing
...
Congratulations on the flip! Update the opportunity:

1. Go to **Kanban** or **Opportunities**
2. Find your item
3. Click **Edit**
4. Change status to **SOLD**
5. Enter **Resale Price:** (what buyer paid)
6. Enter **Resale Platform:** (eBay, FB, etc.)
7. Enter **Sale Date**
8. Add **Notes:** (how long to sell, buyer feedback)
...
- ⏱️ **Average Flip Time:** Days from buy to sell
- 🏆 **Best Flip:** Highest profit item
...
**Tax Tip:** Keep records of all purchases and sales for Schedule C (sole proprietor) or LLC tax filing.
...
- ❌ Never give out personal address
