...
test.describe('Opportunities Page - Acceptance Tests', () => {
  ...
  test.describe('Given a user is viewing the opportunities page', () => {
    test('should display the page title and key elements', async ({ page }) => {
      ...
      const searchOrFilter = page
        .locator('input[placeholder*="Search"], input[type="search"], button:has-text("Filter")')
        .first();
    ...
    test('should display opportunities in a list or kanban board', async ({ page }) => {
      ...
      const opportunityElements = page.locator(
        '[data-testid*="opportunity"], [class*="opportunity"], article, [role="article"]'
      );
    ...
    test('should allow switching between Kanban and List views', async ({ page }) => {
      ...
      const kanbanToggle = page
        .locator(
          'button:has-text("Kanban"), button[aria-label*="Kanban"], [data-testid="kanban-view"]'
        )
        .first();
      const listToggle = page
        .locator('button:has-text("List"), button[aria-label*="List"], [data-testid="list-view"]')
        .first();
  ...
  test.describe('When a user searches for opportunities', () => {
    test('should filter results based on search input', async ({ page }) => {
      ...
      if (await searchInput.isVisible().catch(() => false)) {
        ...
        const url = page.url();
        const hasQueryParam =
          url.includes('search') || url.includes('q=') || url.includes('vintage');
    ...
    test('should clear search when clear button is clicked', async ({ page }) => {
      ...
      if (await searchInput.isVisible().catch(() => false)) {
        ...
        const clearButton = page
          .locator('button[aria-label*="Clear"], button:has-text("✕"), button:has-text("Clear")')
          .first();
  ...
  test.describe('When a user filters opportunities', () => {
    ...
    test('should allow filtering by price range', async ({ page }) => {
      ...
      const minPriceInput = page
        .locator('input[placeholder*="Min"], input[name*="minPrice"]')
        .first();
      const maxPriceInput = page
        .locator('input[placeholder*="Max"], input[name*="maxPrice"]')
        .first();
    ...
    test('should allow filtering by marketplace platform', async ({ page }) => {
      ...
      const platformFilter = page
        .locator(
          'select[name*="platform"], button:has-text("Platform"), [data-testid*="platform-filter"]'
        )
        .first();
  ...
  test.describe('When a user sorts opportunities', () => {
    test('should allow sorting by different criteria', async ({ page }) => {
      ...
      const sortControl = page
        .locator('select[name*="sort"], button:has-text("Sort"), [data-testid*="sort"]')
        .first();
  ...
  test.describe('When a user views opportunity details', () => {
    test('should display key information for each opportunity', async ({ page }) => {
      ...
      const firstOpportunity = page
        .locator('[data-testid*="opportunity"], article, [class*="opportunity-card"]')
        .first();
    ...
    test('should display marketplace source and external link', async ({ page }) => {
      ...
      const platformBadge = page
        .locator('text=/ebay|craigslist|facebook|offerup|mercari/i')
        .first();
      const externalLink = page
        .locator('a[href*="ebay"], a[href*="craigslist"], a[target="_blank"]')
        .first();
  ...
  test.describe('When a user manages opportunity status', () => {
    test('should allow changing status from interested to contacted', async ({ page }) => {
      ...
      const statusButton = page
        .locator(
          'button:has-text("Status"), button:has-text("Contacted"), button:has-text("Interested")'
        )
        .first();
    ...
    test('should allow marking as purchased', async ({ page }) => {
      ...
      const purchasedButton = page
        .locator('button:has-text("Purchased"), button:has-text("Mark as Purchased")')
        .first();
    ...
    test('should allow marking as passed/rejected', async ({ page }) => {
      ...
      const passButton = page
        .locator(
          'button:has-text("Pass"), button:has-text("Reject"), button:has-text("Not Interested")'
        )
        .first();
  ...
  test.describe('When a user adds notes to an opportunity', () => {
    test('should allow opening notes editor', async ({ page }) => {
      ...
      const notesButton = page
        .locator(
          'button:has-text("Notes"), button:has-text("Add Note"), textarea[placeholder*="note"]'
        )
        .first();
    ...
    test('should allow saving notes', async ({ page }) => {
      ...
      const notesInput = page
        .locator('textarea[placeholder*="note"], input[placeholder*="note"]')
        .first();
  ...
  test.describe('Kanban Board Functionality', () => {
    test('should display opportunities in columns by status', async ({ page }) => {
      ...
      const kanbanToggle = page
        .locator('button:has-text("Kanban"), [data-testid="kanban-view"]')
        .first();
    ...
    test('should allow drag-and-drop between columns', async ({ page }) => {
      ...
      if (await kanbanToggle.isVisible().catch(() => false)) {
        ...
        const draggableCard = page
          .locator('[draggable="true"], [data-testid*="opportunity-card"]')
          .first();
  ...
  test.describe('Empty State', () => {
    ...
    test('should provide action to create or scan for opportunities', async ({ page }) => {
      ...
      const ctaButton = page.locator(
        'button:has-text("Scan"), button:has-text("Add"), a:has-text("Get Started")'
      );
