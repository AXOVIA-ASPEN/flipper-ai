...
test.describe('Session Management', () => {
  test.describe('Feature: User Logout', () => {
    test('Scenario: Given an authenticated user, When they click logout, Then they are redirected to login and see "You have been logged out"', async ({
      page,
    }) => {
      ...
      // Mock signOut to redirect to login with loggedOut param so the app shows the message
      ...
      // When: user clicks logout (button, link, or open user menu then "Log out" menuitem)
      ...
      // Then: redirect to login and show "You have been logged out"
