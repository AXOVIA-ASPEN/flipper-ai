...
"[project]/flipper-ai/src/app/api/listings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function GET(request) {
    try {
        ...
        const [listings, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].listing.findMany({
                where,
                orderBy: {
                    scrapedAt: "desc"
                },
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].listing.count({
                where
            })
        ]);
...
async function POST(request) {
    try {
        ...
        const detectedCategory = category || (0, __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$value$2d$estimator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["detectCategory"])(title, description);
        // Estimate value (includes all analysis fields)
        const estimation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$value$2d$estimator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["estimateValue"])(title, description, askingPrice, condition, detectedCategory);
        // Generate purchase request message
        const requestToBuy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$value$2d$estimator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePurchaseMessage"])(title, askingPrice, estimation.negotiable, sellerName);
        // Create or update listing with all fields
        const listing = await __TURBOPACK__imported__module__$5b$project$5d2f$flipper$2d$ai$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].listing.upsert({
            where: {
                platform_externalId: {
                    platform,
                    externalId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c05a6701._.js.map