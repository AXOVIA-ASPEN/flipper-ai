...
<activation critical="MANDATORY">
      ...
      <step n="4">Ensure architecture output goes to _bmad-output/planning-artifacts/architecture.md</step>
  ...
  <memories>
    <memory>Architecture document saves to _bmad-output/planning-artifacts/architecture.md</memory>
    <memory>If sharding, component shards save to _bmad-output/planning-artifacts/architecture-shards/</memory>
    <memory>Test strategy must account for acceptance test structure at test/acceptance/features/</memory>
    <memory>All FR-* and NFR-* requirement IDs from PRD must be traceable through architecture decisions</memory>
  </memories>
  <menu>
