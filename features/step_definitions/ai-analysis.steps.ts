...
Given('a listing with description {string}', async function (this: CustomWorld, description: string) {
  this.currentListing = {
    ...this.currentListing,
    description
  };
...
Given('the market value for {string} is ${int}', async function (this: CustomWorld, itemName: string, marketValue: number) {
...
Then('the flippability score should be between {int} and {int}', async function (this: CustomWorld, min: number, max: number) {
...
Then('the flippability score should be below {int}', async function (this: CustomWorld, maxScore: number) {
  const score = this.analysisResult?.flippabilityScore;
...
Then('the flippability score should be above {int}', async function (this: CustomWorld, minScore: number) {
  const score = this.analysisResult?.flippabilityScore;
...
Then('the confidence level should be {string}', async function (this: CustomWorld, expectedConfidence: string) {
...
Then('the estimated profit should be calculated as:', async function (this: CustomWorld, dataTable) {
...
Then('the risk factors should include {string}', async function (this: CustomWorld, riskFactor: string) {
...
Then('the difficulty rating should be {string}', async function (this: CustomWorld, expectedDifficulty: string) {
...
Then('the difficulty rating should be {string} or {string}', async function (this: CustomWorld, difficulty1: string, difficulty2: string) {
  const difficulty = this.analysisResult?.difficulty?.toLowerCase();
  
  const matches = difficulty === difficulty1.toLowerCase() || difficulty === difficulty2.toLowerCase();
...
Then('the average sold price should be displayed as {string}', async function (this: CustomWorld, expectedAverage: string) {
...
Then('the recommended list price should be {string}', async function (this: CustomWorld, priceRange: string) {
...
Then('the condition multiplier should be approximately {float}', async function (this: CustomWorld, expectedMultiplier: number) {
...
Then('the estimated resale value should be around ${int}', async function (this: CustomWorld, expectedValue: number) {
